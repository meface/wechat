...
class Oauth2 {
   ...
   */
  public function init($APPID,$SECRET,$REDIRECT_URL='http://www.weclouds.cn/api/wechat/test.php'){
   ...
   * (传递state参数)
   */
  public function get_code($state='1'){    
    $APPID=$this->APPID;
   ...
   * 授权获取code
   */
  public function get_code_by_authorize($state){
    $APPID=$this->APPID;
    $redirect_uri=$this->REDIRECT_URL;
  ...
  public function get_userinfo_by_authorize(){
    ...
    $data=array('nickname'=>'','headimgurl'=>'','openid'=>'');
